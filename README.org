...
*** This is a mess/this is confusing
 This was an exercise in learning elisp and programming, and I realized a lot of things along the way. (Mostly, that it’s not as much fun as I thought it was.) I use this package daily to review my schedule because my job demands a lot of long-term scheduling. But I don’t need the vast majority of the features, and suspect you don’t either. I tried to cover most reasonable use cases. 
